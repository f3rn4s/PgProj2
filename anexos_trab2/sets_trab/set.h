...
#define MAX_SET 256            ///  cardinalidade máxima do conjunto

typedef int Set[MAX_SET+1]; 	/// Set tipo array onde se armazenam os elementos do conjunto


/// protótipos das funções de manipulação de conjuntos-----------------------------
 ...
 */
bool set_is_member(const Set set,  int elem );
